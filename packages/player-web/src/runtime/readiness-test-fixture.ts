...
function manifestFixture(): Readonly<CompiledManifestV01> {
  ...
  return Object.freeze({
    ...
    units: Object.freeze([
      ...
      Object.freeze({
        ...
        kind: "bridge",
        frameCount: 2,
        samples: Object.freeze([sample(rendition, 8, 2)])
      }),
      Object.freeze({
        id: "rev",
        kind: "reversible",
...
function body(
  ...
  return Object.freeze({
    ...
    samples: Object.freeze([sample("opaque", sampleStart, frameCount)])
  });
}
